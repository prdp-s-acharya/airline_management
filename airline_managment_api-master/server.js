...
const row1 = fs.readFileSync("./airline_managment_api-master/passangers.json");
let passangers = JSON.parse(row1);
const row2 = fs.readFileSync("./airline_managment_api-master/flights.json");
let fligts = JSON.parse(row2);
